...
//             />
//             <label className="absolute left-0 -top-4 text-grey-800 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-600 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-cyan-700 peer-focus:text-sm">Title</label>
//           </div>
//           <div className='relative w-full sm:w-[70%]'>
...
//             />
//             <label className="absolute left-0 -top-4 text-grey-800 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-600 peer-placeholder-shown:top-2 peer-focus:-top-5 peer-focus:text-cyan-700 peer-focus:text-sm">Description</label>
...
//               />
//               <label className="absolute left-0 -top-4   text-grey-800 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-600 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-cyan-700 peer-focus:text-sm">Author</label>
//             </div>
//             <div 
...
//                 >
//                   <label className="absolute left-0 -top-8 text-grey-800 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-600 peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-cyan-700 peer-focus:text-sm">
//                     Upload Image
//                   </label>
//                   <span id="file-name" className="text-grey-800">Drop or Upload your image</span>
//                 </div>
//               </div>
//           </div>
...
const AddJournals = () => {
  ...
  // Function to extract generated content
  const extractGen = (content) => {
    const cleanedContent = content.replace(/\n/g, '').replace(/\*/g, '');
    const sentences = cleanedContent.split(/[.!?]+/);
    sentences.shift();
  ...
  return (
    <div className='p-4 '>
      <div className='flex items-center flex-col'>
        <div className='text-4xl p-4'>LAUNCHING A NEW JOURNAL</div>
        <div className='flex flex-col gap-y-[2rem] w-[80%] mt-[1rem] items-center '>
          <div className='relative w-full sm:w-[70%]'>
            <input type='text' className='peer h-10 border-solid w-full border-b-2 border-gray-800 text-black bg-transparent placeholder-transparent focus:outline-none focus:border-gray-800' placeholder=''
              value={title} name='title' onChange={(e) => { setTitle(e.target.value) }} required
          ...
          <div className='relative w-full sm:w-[70%]'>
            <textarea type='text' className='peer h-10 border-solid w-full border-b-2 border-gray-800 text-black bg-transparent placeholder-transparent focus:outline-none focus:border-gray-800' placeholder=''
              ...
              onChange={(e) => {
                const words = e.target.value.trim().split(/\s+/); // Split by whitespace
                if (words.length <= 15) { // Limit to 15 words
                  setDescription(e.target.value);
                } else {
                  toast.error('Description must be 12-15 words');
                }
              }} required
            />
            <label className="absolute left-0 -top-4 text-grey-800 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-600 peer-placeholder-shown:top-2 peer-focus:-top-5 peer-focus:text-cyan-700 peer-focus:text-sm">DESCRIPTION</label>
            ...
            <div 
              ...
              >
                ...
                >
                  ...
                  <span id="file-name" className="text-grey-800">DROP OR ADD THE IMAGE</span>
                </div>
              </div>
          </div>
          <button className='bg-cyan-500 px-3 py-3 rounded-lg mt-7 text-2xl shadow-xl' onClick={handleSubmit}>PUBLISH !</button>
