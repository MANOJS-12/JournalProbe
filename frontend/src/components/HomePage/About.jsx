  ...
  return (
    ...
    <section id='about' className=''>
      <div className='text-center '>
        ...
        <div className='mb-[4rem]'><span className='text-4xl py-2  px-4 bg-cyan-500 rounded-xl shadow-xl'>About Us</span></div>
        ...
        <div className='w-[40%] flex items-center justify-center'><img className='h-[25rem] rounded-full mr-7' src={'https://journey.cloud/content_assets/journal/closeup-hands-writing-journal.jpg'} alt='hello'></img></div>
          </div>
        </div>
      </div>
    </section>
